...
AR="/home/parkin/git/emscripten/emar"
RANLIB="/home/parkin/git/emscripten/emranlib"
if [ "$PARALLEL" = no ]; then
...
RunTest()
{
    ...
    echo
    echo "#################  $1  #################"
    emcc -o $TEST_EXEC $Test -I../../../include libz.a /home/parkin/git/hdf5.js/em-build/hdf5/lib/libhdf5.so
    if [ $? -ne 0 ]
    then
